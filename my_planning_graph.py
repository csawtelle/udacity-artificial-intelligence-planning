...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        a_level = self.a_levels[level - 1] #The A level is always above the S level
        s_level = self.s_levels[level]
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        if node_s1.symbol == node_s2.symbol and node_s1.is_pos and not node_s2.is_pos:
          return True
        return False
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
          for level, nodes in enumerate(self.s_levels):
            if PgNode_s(goal, True) in nodes:
